...
input_csv = "input.csv"  # change as needed
...
# Fixed coupon dimensions and spacing
coupon_width = 70 * mm
coupon_height = 30 * mm
spacing_x = 5 * mm
spacing_y = 5 * mm
...
usable_height = page_height - 2 * margin - 20 * mm  # Extra space for header
...
def draw_coupon(c, x, y, flat_no, day, meal_type, width=coupon_width, height=coupon_height, logo_path="logo.png"):
    # Background color
    ...
    # Draw logo bottom right inside coupon
    logo_width = 20 * mm
    logo_height = 15 * mm
